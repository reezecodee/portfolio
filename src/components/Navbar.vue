        ...
        <nav
            ...
            <div class="py-4 px-4 md:px-0 max-w-none md:max-w-3xl flex justify-between items-center container mx-auto">
                ...
                <div id="toggleTarget" :class="isSidebarOpen ? 'block' : 'hidden'"
                    ...
                    <button class="text-black dark:text-white font-semibold ml-0 my-6 md:my-0 md:ml-8 block md:inline"
                        id="theme-toggle">
                        ...
                        <svg v-if="theme === 'light'" class="inline-block align-middle" width="19" height="19" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor">
